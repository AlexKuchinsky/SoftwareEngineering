...
import kotlinx.android.synthetic.develop.activity_main.*
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                Snackbar.make(mainActivityLayout, message, Snackbar.LENGTH_INDEFINITE)
                        .setAction("GRANT") {requirePhoneStatePermission()}
                        .show()
            } else {
               requirePhoneStatePermission()
            }
        }
    }
    
    private fun requirePhoneStatePermission(){
